...
def actualiza_info(screen, mensaje, t_juego, puntuacion, posx = 10, posy = HEIGHT - 40, width = WIDTH, height= 40, color_text=(0, 0, 0), color_ftext=COLOR_FONDO):
...
def main():
    ...
    while True:
        ...
        if time_msg >= 3000:
            time_msg = 0
            actualiza_info(screen,'', str_time_juego, puntuacion, color_ftext= COLOR_FONDO)
